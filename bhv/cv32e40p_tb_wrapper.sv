...
`ifdef CV32E40P_RVFI_TRACE_EXECUTION
`ifdef VERILATOR
  verilator_rvfi_trace cv32e40p_tracer_i (
      .clk_i        (clk_i),
      .rst_ni       (rst_ni),
      .hart_id_i    (cv32e40p_top_i.core_i.hart_id_i),
      ...
      .rvfi_mem_addr(rvfi_i.rvfi_mem_addr),
      .rvfi_mem_rmask(rvfi_i.rvfi_mem_rmask),
      .rvfi_mem_wmask(rvfi_i.rvfi_mem_wmask),
      .rvfi_mem_rdata(rvfi_i.rvfi_mem_rdata),
      .rvfi_mem_wdata(rvfi_i.rvfi_mem_wdata)
  );
`else
  cv32e40p_rvfi_trace #(
      .FPU  (FPU),
      ...
      .rvfi_valid(rvfi_i.rvfi_valid),
      .rvfi_insn(rvfi_i.rvfi_insn),
      .rvfi_start_cycle(rvfi_i.rvfi_start_cycle),
      .rvfi_start_time(rvfi_i.rvfi_start_time),
      .rvfi_stop_cycle(rvfi_i.rvfi_stop_cycle),
      .rvfi_stop_time(rvfi_i.rvfi_stop_time),
      .rvfi_pc_rdata(rvfi_i.rvfi_pc_rdata),
      .rvfi_trap(rvfi_i.rvfi_trap),
      .rvfi_rd_addr(rvfi_i.rvfi_rd_addr),
      .rvfi_rd_wdata(rvfi_i.rvfi_rd_wdata),
      .rvfi_frd_wvalid(rvfi_i.rvfi_frd_wvalid),
      .rvfi_frd_addr(rvfi_i.rvfi_frd_addr),
      .rvfi_frd_wdata(rvfi_i.rvfi_frd_wdata),
      .rvfi_2_rd(rvfi_i.rvfi_2_rd),
      .rvfi_rs1_addr(rvfi_i.rvfi_rs1_addr),
      .rvfi_rs2_addr(rvfi_i.rvfi_rs2_addr),
      .rvfi_rs3_addr(rvfi_i.rvfi_rs3_addr),
      .rvfi_rs1_rdata(rvfi_i.rvfi_rs1_rdata),
      .rvfi_rs2_rdata(rvfi_i.rvfi_rs2_rdata),
      .rvfi_rs3_rdata(rvfi_i.rvfi_rs3_rdata),
      .rvfi_frs1_addr(rvfi_i.rvfi_frs1_addr),
      .rvfi_frs2_addr(rvfi_i.rvfi_frs2_addr),
      .rvfi_frs3_addr(rvfi_i.rvfi_frs3_addr),
      .rvfi_frs1_rvalid(rvfi_i.rvfi_frs1_rvalid),
      .rvfi_frs2_rvalid(rvfi_i.rvfi_frs2_rvalid),
      .rvfi_frs3_rvalid(rvfi_i.rvfi_frs3_rvalid),
      .rvfi_frs1_rdata(rvfi_i.rvfi_frs1_rdata),
      .rvfi_frs2_rdata(rvfi_i.rvfi_frs2_rdata),
      .rvfi_frs3_rdata(rvfi_i.rvfi_frs3_rdata),
      .rvfi_mem_addr(rvfi_i.rvfi_mem_addr),
      .rvfi_mem_rmask(rvfi_i.rvfi_mem_rmask),
      .rvfi_mem_wmask(rvfi_i.rvfi_mem_wmask),
      .rvfi_mem_rdata(rvfi_i.rvfi_mem_rdata),
