...
(
  ...
  // SMX
  output smx_opcode_e smx_operator_o,          // SMX operation selection
  output logic        smx_en_o,                // SMX enable
  ...
  begin: instruction_decoder
    ...
    unique case (instr_rdata_i[6:0])
      ...
      OPCODE_CUSTOM_0: begin
        // Softmax Custom Unit Instructions
        // func3 encoding:
        // 000: SMX.MAX
        // 001: SMX.ACC
        // 010: SMX.EXP
        ...
        // Default register usage (all use rs1, rs2, rd)
        rega_used_o    = 1'b1;
        regb_used_o    = 1'b1;
        regfile_alu_we = 1'b1; // Write result to RD

        unique case (instr_rdata_i[14:12])
          3'b000: begin // SMX.MAX
            smx_operator_o     = SMX_CONTX;
            regc_used_o        = 1'b1;
            alu_op_c_mux_sel_o = OP_C_REGC_OR_FWD; // Read RD
            regc_mux_o         = REGC_RD;
          end
          3'b001: begin // SMX.ACC
            smx_operator_o     = SMX_ACC;
            regc_used_o        = 1'b1;
            alu_op_c_mux_sel_o = OP_C_REGC_OR_FWD; // Read RD
            regc_mux_o         = REGC_RD;
          end
          3'b010: begin // SMX.EXP
            smx_operator_o = SMX_EXP;
          end
          3'b011: begin // SMX.SIGM
            smx_operator_o = SMX_SIGM;
          end
          default: begin
            smx_en_o       = 1'b0;
            illegal_insn_o = 1'b1;
