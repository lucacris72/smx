...
#(
  ...
  // SMX signals
  logic [31:0] smx_result;

  smx_fu_lut #(
      .REGISTER_FINAL_OUTPUT(1'b0) // Combinational output, registered in EX/WB pipe
  ) smx_unit_i (
      .clk          (clk),
      .rst_n_i      (rst_n),
      .smx_en_i     (smx_en_i),
      .smx_operator_i (smx_operator_i),
      .rs1_value    (alu_operand_a_i),
      .rs2_value    (alu_operand_b_i),
      .rd_value     (alu_operand_c_i),
      .wb_contx_o     (),
      .wb_acc_o     (),
      .wb_exp_o     (),
      .wb_sigm_o    (),
  ...
  always_comb begin
    ...
    if (apu_valid & (apu_singlecycle | apu_multicycle)) begin
      ...
      if (smx_en_i) regfile_alu_wdata_fw_o = smx_result;
    end
  end
  ...
  assign ex_valid_o = (apu_valid | alu_en_i | mult_en_i | csr_access_i | lsu_en_i | smx_en_i)
